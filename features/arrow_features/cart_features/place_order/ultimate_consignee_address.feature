...
@mobile @tablet
@full @cart_smoke
Feature: As an arrow.com user, if I selected a freight forwarder shipping address I also see the ultimate consignee address for the order on place order Page
  ...
  Scenario: Display ultimate consignee address in Shipping Address section of Confirmation page
    ...
    And I click the checkout button
    Then the place order page shipping address section displays ultimate consignee address
